...
export const PRIVACY_POLICY = {
  ...
  internal_record_list: [
    ...
    {
      text: "To process the payments with respect to the transactions which you may avail on the Porter Apps and to perform ancillary Services",
    },
    {
      text: "To respond to your comments. reviews and questions, in order to provide customer support and better Services",
    },
    {
      text: "To communicate important notices and changes to the Services provided on the Porter Apps",
    },
    {
      text: "To track the order status, processing, and delivery of Services as per your applicability",
    },
    {
      text: "For any other purposes with your consent.",
    },
  ],
  internal_record_keeping_desc2:
  ...
  internal_record_keeping_desc4:
    "You may specifically opt-out of the above in accordance with the Telecom Commercial Communications Customer Preference Regulations, 2018 or otherwise specified. In case you wish to opt out of the same, please contact us at 4410 4410 (add your city code).",
  security: "Security",
  security_para: `We are committed to ensuring that your information is secure. In order to prevent unauthorized access or disclosure we have put in place suitable physical, electronic and managerial procedures in accordance with the Information Technology (Reasonable security practices and procedures and sensitive personal data or information) Rules, 2011 ("IT RSP Rules") to safeguard and secure the information we collect online. We do not retain any information collected from you for any longer than is reasonably required by us for the purpose of our Services or such period as may be required by applicable laws in India. You are required to keep your information and all the other data you obtain on the Porter Apps strictly confidential.`,
  disclosure: "Disclosure",
  disclosure_desc1:
    "We may disclose to third party services certain personally identifiable information listed below:",
  disclosure_list1: [
    {
      text: "Information you provide us such as name, email, mobile phone number, language.",
    },
    {
      text: "Information we collect as you access and use our service, including device information, location and network carrier. We collect precise or approximate location data in foreground when the Porter Apps from the users’ mobile devices if they enable us to do so. Porter collects this data from the time a ride or delivery is requested until it is finished, and any time the app is running in the foreground of their mobile device. We use this data to enhance your use of our apps, including to improve pick-up locations, enable safety features, and prevent and detect fraud. Porter collects the Driver Partner’s location data, and links location data collected during a trip with their customer’s account, even if the customer has not enabled us to collect location data from their device. This enables us to offer Services to the customers like receipt generation and customer support.",
    },
  ],
  disclosure_desc2:
    "This information is shared with third party service providers under contracts entered into with them so that we can:",
  disclosure_list2: [
    {
      text: "Personalize the Porter Apps for you so you get the smoothest experience.",
    },
    {
      text: "Perform behavioural analytics.",
    },
    {
      text: "Sharing of information with our Vendors, Consultants, Marketing Partners, Research Firms and other Service Providers or Business Partners such as payment processing entities, to support our Services.",
    },
    {
      text: "We may share your information with our academic partners for the purposes of carrying out academic research.",
    },
    {
      text: `In case if you are a Driver Partner with MIGHTY MOVERS, we may share you name, phone number and/or profile picture (if applicable) with other users in order to provide them the Services.`,
    },
    {
      text: "We may disclose this information with the Governmental Agencies, enforcement agencies or other companies assisting us, when we are obligated under applicable laws or in good faith or in compliance to any orders or processes; or detecting and preventing against actual or potential occurrence of identity theft, fraud, abuse of Services and other illegal acts.",
    },
  ],
  prohibited_activities: "PROHIBITED ACTIVITIES",
  prohibited_activites_desc:
  ...
  prohibited_activities_desc2:
    "In case of with non-compliance with rules and regulations, Policy or the terms of service, we have the right to terminate the access or usage rights of the users to the computer resource or the Porter Apps immediately or remove non-compliant information or both, as the case may be.",
  withdrawal_non_provition: "WITHDRAWAL OR NON PROVISION OF DATA",
  withdrawal_non_provition_para:
    "Please note that You shall have an option not to provide the data or information sought to be collected. You shall, at any time while availing the Services or otherwise, also have an option to withdraw its consent given earlier to Porter by contacting us. Such withdrawal of the consent shall be sent in writing to the body corporate. However, in such cases, Porter shall have the option not to provide any Services for which the said information was sought.",
  ...
  cookies_para_list: [
    ...
    {
      para: "We use traffic log cookies to identify which pages are being used. This helps us analyze data about webpage traffic and improve our website in order to tailor it to customer needs. We only use this information for statistical analysis purposes and then the data is removed from the system.",
    },
    {
      para: "Overall, cookies help us provide you with a better website, by enabling us to monitor which pages you find useful and which you do not. A cookie in no way gives us access to your computer or any information about you, other than the data you choose to share with us.",
    },
    {
      para: "You can choose to accept or decline cookies. Most web browsers automatically accept cookies, but you can usually modify your browser setting to decline cookies if you prefer. This may prevent you from taking full advantage of the website and/or Porter Apps.",
    },
  ],
  link: "LINK TO OTHER WEBSITES",
  link_list: [
    {
    ...
    {
      para: "We will not disclose or share your personal information to third parties unless we have your permission or are required by law to do so. We may use your personal information to send you promotional information about third parties which we think you may find interesting if you tell us that you wish this to happen",
    },
    {
      para: "You may request details of personal information which we hold about you under the Information Technology (Reasonable security practices and procedures and sensitive personal data or information) Rules, 2011. If you would like a copy of the information held on you please contact us.",
    },
    {
      para: "If you believe that any information we are holding on you is incorrect or incomplete, please write to or email us as soon as possible, at the above address. We will promptly correct any information found to be incorrect.",
    },
  ],
  contact: "CONTACT US",
  contact_para:
  ...
  grievance_list: [
    { text: "Legal Team," },
    { text: "Mighty Movers Pvt. Ltd." },
    { text: "No. 10, Sundarvan Society," },
    { text: "Besides Hyatt Regency, Ashram Road," },
    { text: "Usmanpura, Ahmedabad," },
    { text: "Gujarat 380014, India" },
    { text: "Email Id: mightymovers@transport.in" },
    { text: "Time: Monday to Friday (10 a.m. to 10 p.m.)" },
    {
      text: "For any queries or concerns regarding our Services, kindly email us at help@mightymovers.com.",
    },
  ],
};
