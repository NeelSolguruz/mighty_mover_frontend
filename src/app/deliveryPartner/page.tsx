    ...
    <>
      ...
      <div className="w-full">
        <div className="flex flex-col md:flex-col w-full justify-between p-5 md:p-10">
          <div className="w-full md:w-fit md:flex-row flex max-md:flex-wrap flex-nowrap justify-center gap-5 md:ml-0 xl:ml-24  md:justify-center ">
    ...
    <div className="flex flex-col md:flex-row gap-5 items-center justify-center">
      <div className="w-full md:w-1/3">
        <Image
          ...
          className="w-full h-96 rounded-lg object-contain shadow-md transition-all hover:scale-105"
          alt="Picture of the Delivery"
        />
      </div>
            ...
            >
              <div className="divForImage w-full h-48 relative">
                <Image
                  ...
                  layout="fill"
                  objectFit="cover"
                  className="rounded-lg shadow-gray-400 shadow-md transition-all hover:scale-105"
                />
              </div>
