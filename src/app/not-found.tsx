...
export default function notFound() {
    return (
        <>
            <div className="w-[99%] h-screen flex items-center">
                    ...
                    <div className="flex flex-col w-5/12 justify-center items-end max-lg:w-full">
                        <div className="flex flex-col gap-5 w-11/12">
                            ...
                            <div className="flex gap-3">
                                <button onClick={() => window.history.back()} className="bg-[#2967ff] p-2 rounded-lg font-semibold text-lg text-white hover:bg-blue-500 transition duration-200 flex items-center gap-x-2"><FaArrowLeft /> Go back</button>
