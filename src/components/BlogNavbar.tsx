...
export default function BlogNavbar() {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center ">
      {sidebar ? (
        <>
          <div className="w-[300px] bg-white opacity-95 h-lvh absolute top-0 left-0 ">
            ...
            {blog_social_media.map((item) => (
              <>
                <div className="flex gap-4 w-full p-4 justify-center items-end hover:shadow-md hover:shadow-gray-200 transition-all duration-300 hover:scale-100 hover:text-[18px]">
                  ...
                  <div className="w-full flex justify-start">{item.name}</div>
                </div>
              </>
            ))}
            <div className="pl-3">
      ...
      <div className="hidden max-tablet:block w-[196px] pl-4" onClick={handlesidebar}>
  ...
  <div className="w-11/12 flex justify-center items-center py-0.5 border-t-[1px] border-b-[1px] gap-4 sticky top-20 z-10 bg-white opacity-95 hover:py-6 transition-all duration-00 max-[1081px]:w-full max-tablet:hidden">
    <Link href="/">
              ...
              <div className="flex flex-col justify-center w-full">
                ...
                <div className="w-full flex justify-center  ">
                  {filter_data.length === 0 ? (
                    ...
                    <>
                      <div className="bg-white flex flex-col gap-4 w-3/4 justify-between overflow-y-scroll h-[200px]">
                ...
                <div className="absolute top-5 right-5">
                  <button className="text-3xl font-bold" onClick={searchmodal}>
                    <Image src={cross} alt="cross"></Image>
                  </button>
                </div>
              </div>
