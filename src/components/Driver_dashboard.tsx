  ...
  return (
    <div className="w-full bg-gray-100 flex flex-col ">
      <div className="flex w-full h-full gap-2 p-4">
        ...
        <div className="rounded-lg shadow-lg shadow-gray-400 bg-white w-full">
          <table>
            <thead>
              <td>Order Id</td>
              <td>Amount</td>
