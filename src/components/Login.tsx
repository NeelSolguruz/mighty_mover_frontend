      ...
      <div className="w-full flex justify-center">
        <div className="flex flex-col items-center gap-10 py-10 w-5/12 max-lg:w-8/12 max-sm:w-11/12">
          ...
          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-10">
            ...
            <div className="w-full">
              <Link href="/register">
                <button className="w-full border-2 border-yellow-500 p-3 rounded-md font-bold transition-all text-lg text-yellow-500 hover:bg-yellow-400 hover:text-black hover:border-2 hover:border-yellow-400">
                  Create your account
                </button>
              </Link>
            </div>
