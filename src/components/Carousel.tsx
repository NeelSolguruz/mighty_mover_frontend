  ...
  return (
    <div className="overflow-hidden relative">
      ...
      <div className="absolute inset-0 flex justify-between items-center p-4">
        <button
          className="w-auto h-auto bg-white p-2 rounded-full hover:scale-90 transition-all duration-100"
          onClick={prev}
        >
      ...
      <div className="absolute bottom-10 left-10">
            ...
            <div className="text-xs font-bold bg-[#2967ff] p-2.5 text-white rounded-md tracking-widest w-full text-center border-[#2967ff] border-2  hover:bg-white hover:text-[#2967ff] hover:border-[#2967ff] hover:border-2 transition-all duration-100">
                View Post
            </div>
            </div>
      </div>
